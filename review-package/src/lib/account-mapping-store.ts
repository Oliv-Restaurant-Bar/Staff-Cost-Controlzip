...
export const DEFAULT_ACCOUNTS: AccountMapping[] = [
  ...
  { accountNumber: '4701', accountName: 'Betriebsmaterial Restauration',    plCategory: 'other_operating', plSection: 'operating_expenses', department: 'service', sign: 'expense', canOverride: true, isActive: true, source: 'default', notes: 'Betriebskosten, NICHT Wareneinsatz/WKQ (Warenkosten = nur 4000–4090)' },
  ...
  { accountNumber: '4800', accountName: 'Einkaufsabrechnungskonto Gebinde', plCategory: 'other_operating', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default', notes: 'Neutrales Verrechnungskonto (Gebinde-Abrechnung) — NICHT Wareneinsatz/WKQ' },
  ...
  { accountNumber: '5005', accountName: 'Personal-Karate',               plCategory: 'personnel_kitchen', plSection: 'personnel', department: 'general', sign: 'expense', canOverride: true,  isActive: true, source: 'default' },
  ...
  { accountNumber: '6611', accountName: 'Kost & Logis Personal', plCategory: 'personnel_other', plSection: 'personnel',          department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default', notes: 'Kost & Logis Personal — Personalaufwand, NICHT Werbung/Marketing (Bereich 6600–6699 für dieses Konto überschrieben)' },
