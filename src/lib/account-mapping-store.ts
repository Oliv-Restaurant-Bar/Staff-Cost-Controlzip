...
export const DEFAULT_ACCOUNTS: AccountMapping[] = [
  ...
  { accountNumber: '4702', accountName: 'Blumen / Dekoration Restauration', plCategory: 'other_operating', plSection: 'operating_expenses', department: 'service', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '4703', accountName: 'Brennmaterial (Pizzaofen)',         plCategory: 'utilities',       plSection: 'operating_expenses', department: 'kitchen', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '4800', accountName: 'Einkaufsabrechnungskonto Gebinde', plCategory: 'cogs_other',      plSection: 'cogs', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  ...
  { accountNumber: '4900', accountName: 'Warenbestand Korrektur',           plCategory: 'cogs_other',      plSection: 'cogs', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default', notes: 'Kann positiv oder negativ sein' },
  ...
  { accountNumber: '6101', accountName: 'Leasing Maschinen und App.',    plCategory: 'maintenance', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  ...
  { accountNumber: '6140', accountName: 'URE Informatik EDV',            plCategory: 'admin_costs', plSection: 'operating_expenses', department: 'admin',   sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  ...
  // Fahrzeugkosten
  { accountNumber: '6200', accountName: 'Fahrzeug Rep., Service',    plCategory: 'other_operating', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '6210', accountName: 'Fahrzeug Benzin',           plCategory: 'other_operating', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '6220', accountName: 'Fahrzeug Versicherung',     plCategory: 'insurance',       plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '6230', accountName: 'Verkehrsabgaben / Steuern', plCategory: 'other_operating', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '6240', accountName: 'Fahrzeugleasing',           plCategory: 'other_operating', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '6250', accountName: 'Fahrzeugmieten',            plCategory: 'other_operating', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  { accountNumber: '6280', accountName: 'Privatanteil Fahrzeugaufw.', plCategory: 'other_operating', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
  // Versicherungen
  { accountNumber: '6300', accountName: 'Sachversicherungen',        plCategory: 'insurance', plSection: 'operating_expenses', department: 'general', sign: 'expense', canOverride: false, isActive: true, source: 'default' },
