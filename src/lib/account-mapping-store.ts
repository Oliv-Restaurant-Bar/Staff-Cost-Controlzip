...
export const DEFAULT_ACCOUNTS: AccountMapping[] = [
  ...
  { accountNumber: '4701', accountName: 'Betriebsmaterial Restauration',    plCategory: 'cogs_other',      plSection: 'cogs', department: 'service', sign: 'expense', canOverride: true, isActive: true, source: 'default' },
