...
export const COCKPIT_SOURCES: CockpitSourceDef[] = [
  ...
  },
  {
    ...
    tabCategory: 'umsatz',
    importType: 'file_upload',
    uploadLabel: 'Gastronovi Z-Bericht PDF',
    sourceHint: 'Export aus Gastronovi → Z-Bericht (PDF)',
    exampleFormat: 'z-bericht_2026-07-06.pdf',
    interval: 'daily',
    description: 'Tages- und Perioden-Z-Berichte (Umsatz) aus Gastronovi als PDF. Frische = spätestes Berichtsende.',
    checklistLabel: 'Z-Bericht PDF importieren',
  ...
  },
  {
    ...
    importType: 'file_upload',
    uploadLabel: 'Erweiterter Z-Bericht PDF (Detailpositionen)',
    sourceHint: 'Primär: erweiterter Z-Bericht PDF; Verkaufsdaten-CSV nur als optionaler Fallback',
    exampleFormat: 'z-bericht_erweitert.pdf (Fallback: produktverkauf.csv)',
    interval: 'daily',
    description:
      'Artikel-/Produktdetails. Primärquelle sind die Detailpositionen des erweiterten Z-Bericht PDFs; der Verkaufsdaten-CSV-Import bleibt nur als optionaler Fallback. Frische = spätestes Verkaufs-/Berichtsdatum. Hinweis: CSV-Datenquelle ist mandantenübergreifend.',
    checklistLabel: 'Produktdetails importieren (erweiterter Z-Bericht PDF)',
    route: '/gastronovi-import',
    actionLabel: 'Zur Gastronovi-Importseite',
    checkable: true,
    tenantNeutral: true,
  ...
  {
    id: 'zeitabschnitte',
    label: 'Zeitabschnitte / Stundenumsätze',
    module: 'Umsatz / Gastronovi',
    category: 'umsatz_gastronovi',
    section: 'import',
    tabCategory: 'umsatz',
    importType: 'file_upload',
    uploadLabel: 'Gastronovi Z-Bericht PDF (Abschnitt Zeitabschnitte)',
    sourceHint: 'Kommt automatisch mit dem Z-Bericht PDF (Abschnitt «Zeitabschnitte»)',
    exampleFormat: 'z-bericht_2026-07-06.pdf',
    interval: 'daily',
    description:
      'Stundenumsätze (Zeitabschnitte) aus dem Z-Bericht PDF. Frische = spätester Tagesbericht mit Zeitabschnittsdaten; Tage ohne Abschnitt fehlen bewusst (fehlend ≠ 0).',
    checklistLabel: 'Zeitabschnitte importieren (Z-Bericht PDF)',
    route: '/gastronovi-import',
    actionLabel: 'Zur Gastronovi-Importseite',
    checkable: true,
  },
  {
    ...
    tabCategory: 'umsatz',
    importType: 'file_upload',
    uploadLabel: 'Gastronovi Auswertung «Anzahl Personen» PDF',
    sourceHint: 'Export aus Gastronovi → Auswertungen → Anzahl Personen (PDF)',
    exampleFormat: 'anzahl_personen_2026-07.pdf',
    interval: 'weekly',
    description:
      'Gästezahlen pro Tag aus der Gastronovi-Auswertung «Anzahl Personen» (PDF). Frische = spätester Tag mit Personenwert; leere Tageswerte bleiben leer (fehlend ≠ 0).',
    checklistLabel: 'Anzahl Personen importieren (PDF)',
    route: '/gastronovi-import',
    actionLabel: 'Zur Gastronovi-Importseite',
    checkable: true,
  },
  {
    id: 'umsatz_pro_person',
    label: 'Umsatz pro Person',
    module: 'Umsatz / Gastronovi',
    category: 'umsatz_gastronovi',
    section: 'import',
    tabCategory: 'umsatz',
    importType: 'file_upload',
    uploadLabel: 'Gastronovi Auswertung «Umsatz pro Person» PDF',
    sourceHint: 'Export aus Gastronovi → Auswertungen → Umsatz pro Person (PDF)',
    exampleFormat: 'umsatz_pro_person_2026-07.pdf',
    interval: 'weekly',
    description:
      'Umsatz pro Person und Tag aus der Gastronovi-Auswertung (PDF). Frische = spätester Tag mit Wert; leere Tageswerte bleiben leer (fehlend ≠ 0).',
    checklistLabel: 'Umsatz pro Person importieren (PDF)',
    route: '/gastronovi-import',
    actionLabel: 'Zur Gastronovi-Importseite',
    checkable: true,
  },
  {
    id: 'durchschnittsbon',
    label: 'Durchschnittsbon',
    module: 'Umsatz / Gastronovi',
    category: 'umsatz_gastronovi',
    section: 'import',
    tabCategory: 'umsatz',
    importType: 'file_upload',
    uploadLabel: 'Gastronovi Auswertung «Durchschnittsbon» PDF',
    sourceHint: 'Export aus Gastronovi → Auswertungen → Durchschnittsbon (PDF)',
    exampleFormat: 'durchschnittsbon_2026-07.pdf',
    interval: 'weekly',
    description:
      'Durchschnittsbon pro Tag aus der Gastronovi-Auswertung (PDF). Frische = spätester Tag mit Bonwert; leere Tageswerte bleiben leer (fehlend ≠ 0).',
    checklistLabel: 'Durchschnittsbon importieren (PDF)',
    route: '/gastronovi-import',
    actionLabel: 'Zur Gastronovi-Importseite',
    checkable: true,
  },
