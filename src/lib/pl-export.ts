...
function addPrevMonthComparison(
  ...
  const rows: VmRow[] = [
    ...
    { label: 'Veränderung Warenvorrat', curV: getKpi(curResult, 'cogs_lager'),     prevV: getKpi(prevResult, 'cogs_lager'),      isResult: false, isExpense: true },
    { label: 'Wareneinsatz total',    curV: getKpi(curResult, 'total_cogs'),      prevV: getKpi(prevResult, 'total_cogs'),      isResult: false, isExpense: true },
