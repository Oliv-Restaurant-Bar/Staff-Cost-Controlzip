...
- [Netto-Umsatz SSOT](umsatz-ssot.md) — umsatz.ts ist die einzige Netto-Quelle (PK + Monatsreport); umsatzIstProTag ist NETTO; Tag-Regel: Ist nur vor heute mit Ist-Stunden.
