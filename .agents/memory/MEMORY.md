...
- [Netto-Umsatz SSOT](umsatz-ssot.md) — umsatz.ts einzige Netto-Quelle (ALLE Views); Maison nie im IST; Supabase-Mount-Loads brauchen store-synced-Retry (RLS liefert vor Session-Hydration still 0 Zeilen).
