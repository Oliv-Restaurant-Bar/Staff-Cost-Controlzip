...
- Kopf-Fallback `erkennungTokenGruppen` (ODER-Gruppen, nur Kopfzone = erste 25 nicht-leere Zeilen): greift NUR wenn keine MWST-Nr matcht; fest an Default-Profile gebunden (nie gelernt). Spahni: [['metzgerei spahni'],['xbea']] — LS tragen keine MWST-Nr.
