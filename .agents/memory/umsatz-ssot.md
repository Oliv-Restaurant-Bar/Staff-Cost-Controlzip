...
## Mandanten-Regeln F/B-Split (seit 08/2026)
...
- `UmsatzTag.restHaelftig` (tenantId==='beaulieu'): nicht kategorisierter Rest inkl. Rabatte/Marketing wird 50/50 verteilt statt anteilig; direkte Kategorien bleiben direkt. Beide Flags kombinierbar (TA zuerst zu Food, dann Rest-Regel). Andere Tenants: Flags fehlen → Verhalten unverändert. UmsatzTag entsteht NUR in ladeUmsatzTage — neuer Konstruktor müsste das Flag selbst setzen.
