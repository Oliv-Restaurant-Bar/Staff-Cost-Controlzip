...
**How to apply:** Live-Flex und Cockpit-PDF verwenden denselben Tagesfakten-Builder und dieselbe kalenderbasierte Cockpit-Grenze. Plan und Ist haben getrennte autoritative Supabase-Eingänge: tenant-gefilterter Dienstplan bzw. MIRUS-Zeilen. Lokale Cache-Zellen sind nur Lade-/Fehler-Fallback; erfolgreiche leere Resultate bleiben leer. Lokale Ist-Absenz-/Zusatzkosten-Overrides bleiben geschützt. Der MIRUS-Stichtag ignoriert `plan_sync` und Zusatzkosten. Eine aktuelle Teilwoche zählt nicht zu «abgerechneten Wochen». Externe Aushilfen, AG-Sätze und Split-Phasen müssen identisch aufgelöst werden; kein zusätzlicher Pro-rata-Schnitt.
