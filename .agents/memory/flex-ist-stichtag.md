...
**How to apply:** Live-Flex und Cockpit-PDF verwenden denselben Tagesfakten-Builder und dieselbe kalenderbasierte Cockpit-Grenze für abgeschlossene Wochen. Wochenwerte bleiben bis zum echten MIRUS-Stichtag (`source !== 'plan_sync'`) gekappt; eine aktuelle Teilwoche zählt trotz vorhandener MIRUS-Daten nicht zu «abgerechneten Wochen». Tenant-Caches, externe Aushilfen, AG-Stundensätze und Split-Phasen müssen identisch aufgelöst werden. Ein manueller Pro-rata-Tag darf die Flex-Abweichungsanalyse nicht zusätzlich beschneiden.
